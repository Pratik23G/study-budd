...
export default function Home() {
  ...
  const line2 = "2. Create effective cheat sheets and learn according to your schedule!!";

  // Create data for your carousel
  const cardsData = [
    {
      title: "Study Prep Sheets",
      description: "Deploy and build your custom study prep sheets based on our new A.I models.",
      icon: "📝"
    },
    {
      title: "Learning Paths", 
      description: "Create personalized learning paths with AI-powered recommendations and progress tracking.",
      icon: "🎯"
    },
    {
      title: "Smart Quizzes",
      description: "Interactive quizzes and assessments powered by advanced machine learning algorithms.",
      icon: "🧠"
    },
    {
      title: "Analytics Dashboard",
      description: "Real-time performance analytics to track your learning progress and identify areas for improvement.", 
      icon: "📊"
    }
  ];
      ...
      <div className="font-sans min-h-screen bg-gradient-to-b from-white to-slate-100 text-slate-900 px-4 py-8 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        <main className="flex flex-col items-center max-w-7xl mx-auto">
          ...
          <div className="text-center space-y-6 sm:space-y-8 w-full">
            {/* First typing text - responsive font sizes */}
            ...
            {/* Second typing text - responsive font sizes */}
            <div className="w-full flex justify-center px-2">
              <h2
            ...
            <div className="flex justify-center pt-4 sm:pt-6 md:pt-8">
              <button className="click-btn btn-style501 px-4 py-2 sm:px-6 sm:py-3 md:px-8 md:py-4 text-sm sm:text-base md:text-lg">
                <span className="relative z-10">ENROLL NOW!!</span>
              </button>
            </div>

            {/* Horizontal Carousel Section - responsive spacing */}
