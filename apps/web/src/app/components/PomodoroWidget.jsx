...
export default function PomodoroWidget() {
  ...
  const { mm, ss, pad2, modeLabel, isRunning, start, pause } = usePomodoro();
        ...
        >
          ...
          {!isRunning ? (
            <span
              ...
              className="text-xs font-bold px-2 py-1 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700"
            >
              Start
            </span>
          ) : (
            <span
              ...
              className="text-xs font-bold px-2 py-1 rounded-lg bg-slate-900 text-white hover:bg-slate-800"
            >
              Pause
            </span>
          )}
